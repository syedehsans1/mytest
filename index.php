...
<head>
    ...
    <title>EASOFTS - Electronic Advancement and Software Solutions</title>
    <style>
        ...
        <div class="row">
            <div class="col-md-6">
                <h1> We promise to bring
                    ...
                    your business. </h1>
                <p> From Mobile Apps to Web Applications to Data Analysis to Digital
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <p> We know the digital marketing trends and with our creative
                    strategies your imagination would be the only limit to your
                    growth. </p>
                <p>
                    <small>Our skill set is specialized yet diverse. We have got any
                        type of IT solutions you would ever want for your thriving
                        business.
                    </small>
                </p>
        ...
        <div class="row">
            <div class="col-lg-4">
                <h2> Explore The Services<br/>
                    We Offer For You </h2>
                <p> Cross Platform Applications, Web Applications, Cloud Services Integration, SEO, Digital Marketing, Data Processing, Data Analysis and much more </p>
                    ...
                    <div class="col">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">We can make the website your company can grow from using the latest tools and technologies keeping your satisfaction and success at our top priority.</p>
                            </div>
                        </div>
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">We know the digital marketing trends and with our creative strategies your imagination would be the only limit to your growth.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Search engines are just like people, all they require is clarity and the right vocabulary to understand what you got to say.</p>
                            </div>
                        </div>
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Our graphics would help you convey your message to the world through your product.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<footer class="container-fluid" id="gtco-footer" style="margin-top: 30px;padding-top:50px">
    <div class="container">
        <div class="row">
            <div class="col-lg-6" id="contact">
                <h4> Contact Us </h4>
                <p><strong>Address:</strong> 334-B, B Block Faisal Town, Lahore, PK 54700</p>
                <p><strong>Mobile No:</strong> +92-349-463-7007</p>
                <p><strong>Email:</strong> syedehsans1@gmail.com</p>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-6">
                        ...
                        <ul class="nav follow-us-nav">
                            <li class="nav-item"><a class="nav-link pl-0" href="https://www.facebook.com/easofts/"><i class="fa fa-facebook"
                            ...
                            <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-google"
                                                                                 aria-hidden="true"></i></a></li> -->
                            <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/company/ea-software-solutions"><i class="fa fa-linkedin"
                                                                                 aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                    <div class="col-6">
                        ...
                        <ul class="nav flex-column services-nav">
                            <li class="nav-item"><a class="nav-link" href="#">Web Applications</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Mobile Applications</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Data Analytics</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Marketing</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">AWS Services</a></li>
